$(document).ready(function()
{
    ...
    if(['.google.', 'bing.', 'yandex.', 'facebook.','x.', 'pinterest.'].some(s => document.referrer.toLowerCase().includes(s)) || ['fb', 'facebook', 'pinterest', 'twitter','x'].some(s => navigator.userAgent.toLowerCase().includes(s)))
    {
